...
{
	class ExpectValueOfTargetsMethodChainNode : ExpectMethodChainRoot<ExpectValueMethodChainNode>, IExpectValueOfTargetsMethodChainNode
	{
		...
		{
			return new ExpectValueOfTargetsMethodChainNode();
		}
